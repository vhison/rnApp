...
/**
 * WorkoutRidesBase
 * auto generated base class for the model WorkoutRidesModel.
 */
export const WorkoutRidesModelBase = ModelBase
  .named('WorkoutRides')
  .props({
    __typename: types.optional(types.literal("WorkoutRides"), "WorkoutRides"),
...
export class WorkoutRidesModelSelector extends QueryBuilder {
...
export function selectFromWorkoutRides() {
  return new WorkoutRidesModelSelector()
}

export const workoutRidesModelPrimitives = selectFromWorkoutRides()._id.countdown.created_at.createdAt.duration.end_time.join_token.pedaling_end_time.pedaling_start_time.ride_id.scheduled_start_time.server_time.start_time.status.title.updatedAt
